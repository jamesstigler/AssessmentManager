...
select * from
--delete 
AssessmentManagerData..REComps where AssessorId=1697 and TaxYear=2024 and AcctNum='00000100129000000'
...
--This comes from the spUpdateREComps stored proc
		...
		ISNULL(tmp1.CONSTR_TYP_DESC,''), ISNULL(tmp1.CITY_EFF_YR,0), ISNULL(tmp1.APPR_METHOD_DESC,''), ISNULL(tmp1.PRICING_METH_DESC,'')
