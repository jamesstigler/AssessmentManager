...
AS
	BEGIN
		...
		INSERT #temptbl (ClientId, LocationId, AssessmentId, AssetId, TaxYear, OriginalCost,
			...
			LeaseType, LessorName, LessorAddress, LeaseTerm, EquipmentMake, EquipmentModel, InterstateAllocationFl
)				
		SELECT c.ClientId, l.LocationId, assess.AssessmentId, a.AssetId, a.TaxYear, ISNULL(a.OriginalCost,0),
			...
			ISNULL(assess.InterstateAllocationFl,ISNULL(c.InterstateAllocationFl,0))
