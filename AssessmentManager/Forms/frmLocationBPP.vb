Public Class frmLocationBPP
    Private bActivated As Boolean
    Private clsLocation As New clsLocationBPP
    ...
    Private Sub InitInfo()
        ...
        DBPrimaryKeys(0).sTable = "LocationsBPP"
    ...
    Private Function OpenLocation() As Boolean
        ...
        Try
            ...
            Me.Text = m_TaxYear & " " & "BPP Location:  " & clsLocation.Address & "   " & clsLocation.City & ", " & clsLocation.StateCd
            RefreshControls(Me, clsLocation.ResultSet, "LocationsBPP")
            Return True
    ...
    Private Sub frmLocationBPP_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        bActivated = False
        bChanged = False
    End Sub
End Class