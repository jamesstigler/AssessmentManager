...
Public Class clsClient
    ...
    Public Function OpenClient(ByRef sError As String) As Boolean
        ...
        Try
            ...
            sError = ""
            sSQL = "SELECT c.*, CASE WHEN c.BillingCd = 1 THEN 'Bill.com' WHEN c.BillingCd = 2 THEN 'Client Download' ELSE NULL END AS BillingCdDescription" &
                ", (select a.AgencyName FROM Agencies a WHERE a.AgencyId = c.AgencyId) AS AgencyName FROM Clients c WHERE c.ClientId = " & m_ClientId
