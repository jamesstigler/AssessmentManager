...
Public Class rptAofADetail
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AssessmentManager.rptAofADetail.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAofADetail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAofADetail = New rptAofADetail()
        rpt.Site = Me.Site
        Return rpt
    End Function
