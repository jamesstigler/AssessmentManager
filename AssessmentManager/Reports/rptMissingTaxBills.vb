...
Public Class rptMissingTaxBills
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AssessmentManager.rptMissingTaxBills.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMissingTaxBills
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMissingTaxBills = New rptMissingTaxBills()
        rpt.Site = Me.Site
        Return rpt
    End Function
