...
Public Class rptTaxAccrualSummary
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptTaxAccrualSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AssessmentManager.rptTaxAccrualSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTaxAccrualSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTaxAccrualSummary = New rptTaxAccrualSummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
