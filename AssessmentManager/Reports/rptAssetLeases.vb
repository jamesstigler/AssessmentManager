...
Public Class rptAssetLeases
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AssessmentManager.rptAssetLeases.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAssetLeases
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAssetLeases = New rptAssetLeases()
        rpt.Site = Me.Site
        Return rpt
    End Function
