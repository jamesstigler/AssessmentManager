...
Public Class rptAssetDetail
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AssessmentManager.rptAssetDetail.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAssetDetail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAssetDetail = New rptAssetDetail()
        rpt.Site = Me.Site
        Return rpt
    End Function
