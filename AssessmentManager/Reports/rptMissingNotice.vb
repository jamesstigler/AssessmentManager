...
Public Class rptMissingNotice
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AssessmentManager.rptMissingNotice.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMissingNotice
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMissingNotice = New rptMissingNotice()
        rpt.Site = Me.Site
        Return rpt
    End Function
