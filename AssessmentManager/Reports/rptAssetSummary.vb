...
Public Class rptAssetSummary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AssessmentManager.rptAssetSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAssetSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAssetSummary = New rptAssetSummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
