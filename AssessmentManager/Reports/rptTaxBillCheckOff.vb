...
Public Class rptTaxBillCheckOff
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AssessmentManager.rptTaxBillCheckOff.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTaxBillCheckOff
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTaxBillCheckOff = New rptTaxBillCheckOff()
        rpt.Site = Me.Site
        Return rpt
    End Function
