...
Public Class rptFixedAssetRecon
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AssessmentManager.rptFixedAssetRecon.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFixedAssetRecon
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFixedAssetRecon = New rptFixedAssetRecon()
        rpt.Site = Me.Site
        Return rpt
    End Function
