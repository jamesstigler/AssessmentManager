...
Public Class rptTaxAccrual
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AssessmentManager.rptTaxAccrual.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTaxAccrual
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTaxAccrual = New rptTaxAccrual()
        rpt.Site = Me.Site
        Return rpt
    End Function
