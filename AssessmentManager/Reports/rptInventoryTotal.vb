...
Public Class rptInventoryTotal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AssessmentManager.rptInventoryTotal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptInventoryTotal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptInventoryTotal = New rptInventoryTotal()
        rpt.Site = Me.Site
        Return rpt
    End Function
