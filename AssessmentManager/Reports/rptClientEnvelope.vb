...
Public Class rptClientEnvelope
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AssessmentManager.rptClientEnvelope.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptClientEnvelope
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptClientEnvelope = New rptClientEnvelope()
        rpt.Site = Me.Site
        Return rpt
    End Function
