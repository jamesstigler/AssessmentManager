...
Public Class rptTaxSavings
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AssessmentManager.rptTaxSavings.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTaxSavings
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTaxSavings = New rptTaxSavings()
        rpt.Site = Me.Site
        Return rpt
    End Function
